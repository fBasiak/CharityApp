    ...
    <form:form method="post" modelAttribute="donation" id="form">
      ...
      <div data-step="2">
        ...
        <div class="form-group form-group--inline">
          <label>
            Liczba 60l worków:
            <form:input path="quantity" type="number" step="1" min="1" name="bags"/>
          </label>
        </div>
      ...
      <div data-step="3">
        ...
        <c:forEach items="${institutions}" var="institution">
          <div class="form-group form-group--checkbox">
            <label>
              <form:radiobutton path="institution" value="${institution}" name="organization"/>
      ...
      <div data-step="4">
        ...
        <div class="form-section form-section--columns">
          ...
          <div class="form-section--column">
            ...
            <div class="form-group form-group--inline">
              <label> Godzina <form:input type="LocalTime" name="time" path="pickUpTime"/> </label>
            </div>
...
<script defer src=<c:url value="/resources/js/app.js"/>></script>
<script defer src=<c:url value="/resources/js/summary.js"/>></script>
